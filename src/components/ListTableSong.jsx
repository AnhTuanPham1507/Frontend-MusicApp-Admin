...
function ListTableSong() {
    const navigate = useNavigate()
    function handleEditSong() {
        navigate('/song-edit')
    }
    function handleCreateSong() {
        navigate('/song-create')
    }
            ...
            <Table striped bordered hover>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <FontAwesomeIcon onClick={handleEditSong} style={{ marginRight: "10px" }} icon={faEdit} />
                            <FontAwesomeIcon onClick={handleRemoveSong} icon={faTrash} />
                        </td>
                    </tr>
                </tbody>
            </Table>
            <Button onClick={handleCreateSong} style={{ marginLeft: "1010px" }} variant="primary">Thêm Bài hát</Button>
        </>
    );
}

export default ListTableSong;